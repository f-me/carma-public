...
* Field meta
  ...
  - `targetCoords`, `targetMap`, `targetAddr`, `targetPartner` and
    such: used to specify fields to show and receive geocoding
    information; documented in geopicker and initOSM docs in
    `map.coffee`
