...
, (21, 'LegalForm', 'Формы организации', null, ARRAY['id', 'label'])
, (22, 'CheckType', 'Вид ТО', null, ARRAY['id', 'label'])
, (23, 'CarClass', 'Классы автомобилей', null, ARRAY['id', 'label'])
, (24, 'VinFormat', 'Форматы VIN', null, ARRAY['id', 'label'])
;
