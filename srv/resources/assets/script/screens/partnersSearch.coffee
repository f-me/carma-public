...
m                             = require "carma/model/main"
{DipQueue}                    = require "carma/sync/dipq"
dict                          = require "carma/dictionaries"
time                          = require "carma/lib/time"
{cancelDialog: partnerCancel} = require "carma/partnerCancel"
  ...
  constructor: (view, args) ->
    ...
    kvm['searchH'] = ko.computed ->
      ...
      ms = for i in s
        ...
        k._meta.q = new MetaQueue(k, models.SearchResults)
