...
-- | Read case id from @id@ request parameter, serve JSON list of
-- towage service ids corresponding to towages of the same car which
-- occured within 30 day period prior to the case creation date.
