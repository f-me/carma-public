...
NOTE: Don't modify this file unless Snap upstream implements a new
model for static/dynamic loading.
...
main = do
    ...
    _ <- withSyslog progName [LogPID] User
...
getActions conf = do
    (msgs, site, cleanup) <- runSnaplet
        (appEnvironment =<< getOther conf) appInit
